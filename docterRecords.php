    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="float-left">
                <h2>DOCTERS  RECORDS</h2>
            </div>            
            <div class="float-right">
                <a href="docForm.html" class="btn btn-success">Add New Docter</a>
              ...
              <tbody>
                <?php
                      include 'css/connection.php';
                       $query="select * from doctor limit 20"; // Fetch all the data from the table customers
